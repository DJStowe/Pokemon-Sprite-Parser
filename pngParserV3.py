...
# To do - Just make Write Tile work and then automate it. 
...
def OpenFile(input_filepath, output_filepath):
    ...
    with open(input_filepath, 'rb') as f:
        ...
        currTile = firstTile
        #print(processor.CurrPixelLocation(currTile))

        
        #Temp code because I'm stoned
        #smart devin you need to make this dynamic then you can move curr tile shit up or
        numColumns = 8
        j = 0
